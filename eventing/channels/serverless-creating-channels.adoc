...
* After you have created a channel, xref:../../eventing/subscriptions/serverless-subs.adoc#serverless-subs[create a subscription] that allows event sinks to subscribe to channels and receive events.
